                    ...
                    <form action="action_page.php" class="was-validated" method="post">
                        <div class="input-group">
                          <input type="hidden" name="id" id="id">
                            <input type="name" class="input--style-3" type="text" placeholder="Name" name="name" required="required" data-error="Please enter your name">
                            

                        </div>
                          <div class="input-group">
                            <input type="birthdate" class="input--style-3 js-datepicker" type="text" placeholder="Birthdate" name="birthday" required="required">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Phone" name="phone" required="required">
                        </div>
                        ...
                        <option value="" disabled selected name="Package" style="color:black;">Choose Your Package</option>
                        <option value="Taj Mahal" name="Package">Taj Mahal</option>
                        <option value="Rajasthan" name="Package">Rajasthan</option>
                        <option value="Leh-Ladakh" name="Package">Leh-Ladakh</option>
                        <option value="Maharashtra" name="Package">Maharashtra</option>
                        <option value="Gujarat" name="Package">Gujarat</option>
                        <option value="Valley Of Flowers" name="Package">Valley Of Flowers</option>
                        </select>
                        </div>
                        <div class="button">
                            <button class="btn btn--pill btn--green" type="submit" name="send_btn">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
